---
title: "Making species specific survival curves for Supplementary Figure 5.1"
author: "Shane Dewees"
...
figure5_1 <- (adfa_survival + rhov_survival)/(mala_survival + hear_survival)/(ceol_survival + sani_survival)/(saap_survival + same_survival)/(enca_survival + hewh_survival) + plot_annotation(tag_levels = "A")

ggsave(filename = "figures5_1.png",
       plot = figure5_1,
       path = here("figures"),
       width = 8.5,
       height = 11,
