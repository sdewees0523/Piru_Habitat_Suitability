...
toyon <- survival %>% 
  ...
  add_row(Plant = "Heteromeles arbutifolia", date = ymd("2021-12-01"), alive = 0, alive_percent = 0)
...
summary(lm(soil_moisture~pc1, data = pca_soil_moisture_april))
...
summary(lm(soil_moisture~pc1, data = pca_soil_moisture_may))
```
