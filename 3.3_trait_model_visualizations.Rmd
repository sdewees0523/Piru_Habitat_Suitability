---
title: "Trait model graphs for main figures"
author: "Shane Dewees"
...
```{r}
load(here("data", "models", "early_spring_model.rds"))
...
height_les1_spring <- expand.grid(les_1 = c(min(cox_early_spring$les_1), 
  ...
  mutate(hazard = predict(early_spring_model, newdata = ., type = "survival", se.fit = T, interval = "confidence")[[1]],
         interval = predict(early_spring_model, newdata = ., type = "survival", se.fit = T, interval = "confidence")[[2]],
...
height_les1_summer <- expand.grid(les_1 = c(min(cox_summer$les_1), 
  ...
  mutate(hazard = predict(summer_model, newdata = ., type = "survival", se.fit = T, interval = "confidence")[[1]],
         interval = predict(summer_model, newdata = ., type = "survival", se.fit = T, interval = "confidence")[[2]],
         lower_int = hazard - interval,
         upper_int = hazard + interval,
         les_1 = case_when(les_1 < -1 ~ "acquisitive",
                           les_1 < 0 & les_1 > -1 ~ "moderate",
