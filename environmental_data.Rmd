...
moisture_logger_4 <- read.csv(here("data", "soil_moisture_data", "Data_loggers", "20841601.csv")) %>% 
...
moisture_logger_5 <- read.csv(here("data", "soil_moisture_data", "Data_loggers", "EM12384 28Apr22-1127.csv")) %>% 
  slice(-(1:2)) %>% 
...
moisture_logger_6 <- read.csv(here("data", "soil_moisture_data", "Data_loggers", "hobo_1.csv"))%>% 
  pivot_longer(cols = 3:7, names_to = "plot", values_to = "soil_moisture") %>% 
  mutate(plot = str_remove(plot, "X"),
         plot = as.numeric(plot),
         date_time = mdy_hm(Date.Time..GMT.08.00)) %>% 
...
moisture_logger_7 <- read.csv(here("data", "soil_moisture_data", "Data_loggers", "hobo_2.csv")) %>% 
  pivot_longer(cols = 3:7, names_to = "plot", values_to = "soil_moisture") %>% 
  mutate(plot = str_remove(plot, "X"),
         plot = as.numeric(plot),
...
moisture_logger_8 <- read.csv(here("data", "soil_moisture_data", "Data_loggers", "hobo_3.csv")) %>% 
  pivot_longer(cols = 3:7, names_to = "plot", values_to = "soil_moisture") %>% 
  mutate(plot = str_remove(plot, "X"),
         plot = as.numeric(plot),
         date_time = mdy_hm(Date.Time..GMT.07.00)) %>% 
...
moisture_logger_9 <- read.csv(here("data", "soil_moisture_data", "Data_loggers", "hobo_4.csv"))%>% 
  pivot_longer(cols = 3:7, names_to = "plot", values_to = "soil_moisture") %>% 
  mutate(plot = str_remove(plot, "X"),
         plot = as.numeric(plot),
         date_time = mdy_hm(Date.Time..GMT.08.00)) %>% 
...
moisture_logger_10 <- read.csv(here("data", "soil_moisture_data", "Data_loggers", "hobo_5.csv"))%>% 
  pivot_longer(cols = 3:7, names_to = "plot", values_to = "soil_moisture") %>% 
  mutate(plot = str_remove(plot, "X"),
         plot = as.numeric(plot),
         date_time = mdy_hm(Date.Time..GMT.08.00)) %>% 
...
```{r}
my_files_1 <- list.files(here("data", "Ibutton_Data", "test"),
                         pattern = ".csv$", recursive = TRUE, full.names = TRUE)
my_files_2 <- list.files(here("data", "Ibutton_Data", "2_16_21", "temperature","skip_14"),
                         pattern = ".csv$", recursive = TRUE, full.names = TRUE)
my_files_3 <- list.files(here("data", "Ibutton_Data", "2_16_21", "temperature","skip_19"),
                         pattern = ".csv$", recursive = TRUE, full.names = TRUE)
my_files_4 <- list.files(here("data", "Ibutton_Data", "4_10_20", "For_R", "Temperature"), 
                         pattern = ".csv$", recursive = TRUE, full.names = TRUE)
my_files_5 <- list.files(here("data", "Ibutton_Data", "4_23_20", "Raw_Data", "Temperature", "skip_14"),
                         pattern = ".csv$", recursive = TRUE, full.names = TRUE)
my_files_6 <- list.files(here("data", "Ibutton_Data", "4_23_20", "Raw_Data", "Temperature", "skip_19"),
                         pattern = ".csv$", recursive = TRUE, full.names = TRUE)
my_files_7 <- list.files(here("data", "Ibutton_Data", "10_22_20", "temperature", "skip_14"), 
                         pattern = ".csv$", recursive = TRUE, full.names = TRUE)
my_files_8 <- list.files(here("data", "Ibutton_Data", "10_22_20", "temperature", "skip_19"), 
                         pattern = ".csv$", recursive = TRUE, full.names = TRUE)
my_files_9 <- list.files(here("data", "Ibutton_Data", "ibutton", "temperature", "skip_14"), 
                         pattern = ".csv$", recursive = TRUE, full.names = TRUE)
my_files_10 <- list.files(here("data", "Ibutton_Data", "ibutton", "temperature", "skip_19"), 
                         pattern = ".csv$", recursive = TRUE, full.names = TRUE)
my_files_11 <- list.files(here("data", "Ibutton_Data", "ibutton_2", "temperature", "skip_14"),
                         pattern = ".csv$", recursive = TRUE, full.names = TRUE)
my_files_12 <- list.files(here("data", "Ibutton_Data", "ibutton_2", "temperature", "skip_19"),
                         pattern = ".csv$", recursive = TRUE, full.names = TRUE)
ibutton_1 <- read_csv(my_files_1, id = "plot") %>% 
  mutate(plot = str_remove(plot, "C:/Users/tenni/OneDrive/Desktop/Piru2020/piru_landscape/data/Ibutton_Data/test/"),
...
ibutton_2 <- read_csv(my_files_2, id = "plot", skip= 14) %>%
  mutate(plot = str_remove(plot, 
                           "C:/Users/tenni/OneDrive/Desktop/Piru2020/piru_landscape/data/Ibutton_Data/2_16_21/temperature/skip_14/"),
         plot = str_remove(plot, ".csv"),
...
ibutton_3 <- read_csv(my_files_3, id = "plot", skip= 19) %>%
  mutate(plot = str_remove(plot, 
                           "C:/Users/tenni/OneDrive/Desktop/Piru2020/piru_landscape/data/Ibutton_Data/2_16_21/temperature/skip_19/"),
         plot = str_remove(plot, ".csv"),
         Value = str_remove(Value, "F,"),
         plot = as.numeric(plot),
         date = mdy(`Date/Time`),
...
ibutton_misc <- read.csv(here("data", "Ibutton_Data", "2_16_21", "temperature", "4.csv"), skip = 19) %>% 
  mutate(plot = 4, 
         date = mdy(Date.Time),
         time = hms(Unit),
...
ibutton_4 <- read_csv(my_files_4, id = "plot") %>% 
  mutate(plot = str_remove(plot, 
                           "C:/Users/tenni/OneDrive/Desktop/Piru2020/piru_landscape/data/Ibutton_Data/4_10_20/For_R/Temperature/"),
         plot = str_remove(plot, ".csv"),
...
ibutton_5 <- read_csv(my_files_5, id = "plot", skip = 14) %>% 
  mutate(plot = str_remove(plot, 
                           "C:/Users/tenni/OneDrive/Desktop/Piru2020/piru_landscape/data/Ibutton_Data/4_23_20/Raw_Data/Temperature/skip_14/"),
         plot = str_remove(plot, ".csv"),
         plot = str_remove(plot, "Plot_"),
         plot = str_remove(plot, "T"),
         plot = as.numeric(plot),
...
ibutton_6 <- read_csv(my_files_6, id = "plot", skip = 19) %>% 
  mutate(plot = str_remove(plot, 
                           "C:/Users/tenni/OneDrive/Desktop/Piru2020/piru_landscape/data/Ibutton_Data/4_23_20/Raw_Data/Temperature/skip_19/"),
         plot = str_remove(plot, ".csv"),
         plot = str_remove(plot, "Plot_"),
         plot = str_remove(plot, "T"),
         plot = as.numeric(plot),
...
ibutton_7 <- read_csv(my_files_7, id = "plot", skip = 14) %>% 
  mutate(plot = str_remove(plot, 
                           "C:/Users/tenni/OneDrive/Desktop/Piru2020/piru_landscape/data/Ibutton_Data/10_22_20/temperature/skip_14/"),
         plot = str_remove(plot, ".csv"),
         plot = str_remove(plot, "Plot_"),
         plot = str_remove(plot, "T"),
         plot = as.numeric(plot),
...
ibutton_8 <- read_csv(my_files_8, id = "plot", skip = 19) %>% 
  mutate(plot = str_remove(plot, 
                           "C:/Users/tenni/OneDrive/Desktop/Piru2020/piru_landscape/data/Ibutton_Data/10_22_20/temperature/skip_19/"),
         plot = str_remove(plot, ".csv"),
         plot = str_remove(plot, "Plot_"),
         plot = str_remove(plot, "T"),
         plot = as.numeric(plot),
...
ibutton_9 <- read_csv(my_files_9, id = "plot", skip = 14) %>% 
  mutate(plot = str_remove(plot, 
                           "C:/Users/tenni/OneDrive/Desktop/Piru2020/piru_landscape/data/Ibutton_Data/ibutton/temperature/skip_14/"),
         plot = str_remove(plot, ".csv"),
         plot = str_remove(plot, "Plot_"),
         plot = str_remove(plot, "T"),
         plot = as.numeric(plot),
...
ibutton_10 <- read_csv(my_files_10, id = "plot", skip = 19) %>%
  mutate(plot = str_remove(plot, 
                           "C:/Users/tenni/OneDrive/Desktop/Piru2020/piru_landscape/data/Ibutton_Data/ibutton/temperature/skip_19/"),
         plot = str_remove(plot, ".csv"),
         plot = str_remove(plot, "Plot_"),
         plot = str_remove(plot, "T"),
         plot = as.numeric(plot),
...
ibutton_11 <- read_csv(my_files_11, id = "plot", skip = 14) %>% 
  mutate(plot = str_remove(plot, 
                           "C:/Users/tenni/OneDrive/Desktop/Piru2020/piru_landscape/data/Ibutton_Data/ibutton_2/temperature/skip_14/"),
         plot = str_remove(plot, ".csv"),
         plot = str_remove(plot, "Plot_"),
         plot = str_remove(plot, "T"),
         plot = as.numeric(plot),
...
ibutton_12 <- read_csv(my_files_12, id = "plot", skip = 19) %>% 
  mutate(plot = str_remove(plot, 
                           "C:/Users/tenni/OneDrive/Desktop/Piru2020/piru_landscape/data/Ibutton_Data/ibutton_2/temperature/skip_19/"),
         plot = str_remove(plot, ".csv"),
         plot = str_remove(plot, "Plot_"),
         plot = str_remove(plot, "T"),
         plot = as.numeric(plot),
