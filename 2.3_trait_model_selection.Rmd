---
title: "Dredge for seasonal cox trait models"
author: "Shane Dewees"
...
## Multi-model selection: planting through July (spring) candidate windows

`na.action` is set once here (not repeated per-model) and restored to R's default
at the very end of the second chunk below. One cluster is created per chunk and
explicitly stopped at the end of that chunk, rather than left running.
...
clusterEvalQ(clu, {library(MuMIn); library(survival)})
...
write.csv(spring_all_dredge_filter, here("data", "models", "dredge_tables", "spring_all_dredge_filtered.csv"), row.names = FALSE)
...
write.csv(early_spring_dredge_filter, here("data", "models", "dredge_tables", "early_spring_dredge_filtered.csv"), row.names = FALSE)
...
write.csv(late_spring_dredge_filter, here("data", "models", "dredge_tables", "late_spring_dredge_filtered.csv"), row.names = FALSE)

stopCluster(clu)
```

## Multi-model selection: July through autumn (summer) candidate windows
...
write.csv(summer_all_dredge_filter, here("data", "models", "dredge_tables", "summer_all_dredge_filtered.csv"), row.names = FALSE)
...
write.csv(summer_dredge_filter, here("data", "models", "dredge_tables", "summer_dredge_filtered.csv"), row.names = FALSE)
...
write.csv(fall_dredge_filter, here("data", "models", "dredge_tables", "fall_dredge_filtered.csv"), row.names = FALSE)
