...
write.csv(survival_gopher, here("data","clean_data", "survival_gopher_raw.csv"), append = FALSE, row.names = FALSE)
```
...
write.csv(height, here("data", "clean_data", "height_gopher_kapplin.csv"), append = FALSE, row.names = FALSE)
```
...
write.csv(growth, here("data", "clean_data", "fall_growth.csv"), append = FALSE, row.names = FALSE)
```
