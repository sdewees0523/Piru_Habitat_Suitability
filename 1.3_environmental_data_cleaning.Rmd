...
ibutton_1 <- read_csv(my_files_1, id = "plot") %>% 
  mutate(plot = str_remove(plot, "C:/Users/tenni/Desktop/Piru2020/piru_landscape/data/raw_data/Ibutton_Data/test/"),
...
ibutton_2 <- read_csv(my_files_2, id = "plot", skip= 14) %>%
  mutate(plot = str_remove(plot, 
                           "C:/Users/tenni/Desktop/Piru2020/piru_landscape/data/raw_data/Ibutton_Data/2_16_21/temperature/skip_14/"),
         plot = str_remove(plot, ".csv"),
...
ibutton_3 <- read_csv(my_files_3, id = "plot", skip= 19) %>%
  mutate(plot = str_remove(plot, 
                           "C:/Users/tenni/Desktop/Piru2020/piru_landscape/data/raw_data/Ibutton_Data/2_16_21/temperature/skip_19/"),
         plot = str_remove(plot, ".csv"),
         Value = str_remove(Value, "F,"),
         plot = as.numeric(plot),
         date = mdy(`Date/Time`),
...
ibutton_4 <- read_csv(my_files_4, id = "plot") %>% 
  mutate(plot = str_remove(plot, 
                           "C:/Users/tenni/Desktop/Piru2020/piru_landscape/data/raw_data/Ibutton_Data/4_10_20/For_R/Temperature/"),
         plot = str_remove(plot, ".csv"),
...
ibutton_5 <- read_csv(my_files_5, id = "plot", skip = 14) %>% 
  mutate(plot = str_remove(plot, 
                           "C:/Users/tenni/Desktop/Piru2020/piru_landscape/data/raw_data/Ibutton_Data/4_23_20/Raw_Data/Temperature/skip_14/"),
         plot = str_remove(plot, ".csv"),
         plot = str_remove(plot, "Plot_"),
         plot = str_remove(plot, "T"),
         plot = as.numeric(plot),
...
ibutton_6 <- read_csv(my_files_6, id = "plot", skip = 19) %>% 
  mutate(plot = str_remove(plot, 
                           "C:/Users/tenni/Desktop/Piru2020/piru_landscape/data/raw_data/Ibutton_Data/4_23_20/Raw_Data/Temperature/skip_19/"),
         plot = str_remove(plot, ".csv"),
         plot = str_remove(plot, "Plot_"),
         plot = str_remove(plot, "T"),
         plot = as.numeric(plot),
...
ibutton_7 <- read_csv(my_files_7, id = "plot", skip = 14) %>% 
  mutate(plot = str_remove(plot, 
                           "C:/Users/tenni/Desktop/Piru2020/piru_landscape/data/raw_data/Ibutton_Data/10_22_20/temperature/skip_14/"),
         plot = str_remove(plot, ".csv"),
         plot = str_remove(plot, "Plot_"),
         plot = str_remove(plot, "T"),
         plot = as.numeric(plot),
...
ibutton_8 <- read_csv(my_files_8, id = "plot", skip = 19) %>% 
  mutate(plot = str_remove(plot, 
                           "C:/Users/tenni/Desktop/Piru2020/piru_landscape/data/raw_data/Ibutton_Data/10_22_20/temperature/skip_19/"),
         plot = str_remove(plot, ".csv"),
         plot = str_remove(plot, "Plot_"),
         plot = str_remove(plot, "T"),
         plot = as.numeric(plot),
...
ibutton_9 <- read_csv(my_files_9, id = "plot", skip = 14) %>% 
  mutate(plot = str_remove(plot, 
                           "C:/Users/tenni/Desktop/Piru2020/piru_landscape/data/raw_data/Ibutton_Data/ibutton/temperature/skip_14/"),
         plot = str_remove(plot, ".csv"),
         plot = str_remove(plot, "Plot_"),
         plot = str_remove(plot, "T"),
         plot = as.numeric(plot),
...
ibutton_10 <- read_csv(my_files_10, id = "plot", skip = 19) %>%
  mutate(plot = str_remove(plot, 
                           "C:/Users/tenni/Desktop/Piru2020/piru_landscape/data/raw_data/Ibutton_Data/ibutton/temperature/skip_19/"),
         plot = str_remove(plot, ".csv"),
         plot = str_remove(plot, "Plot_"),
         plot = str_remove(plot, "T"),
         plot = as.numeric(plot),
...
ibutton_11 <- read_csv(my_files_11, id = "plot", skip = 14) %>% 
  mutate(plot = str_remove(plot, 
                           "C:/Users/tenni/Desktop/Piru2020/piru_landscape/data/raw_data/Ibutton_Data/ibutton_2/temperature/skip_14/"),
         plot = str_remove(plot, ".csv"),
         plot = str_remove(plot, "Plot_"),
         plot = str_remove(plot, "T"),
         plot = as.numeric(plot),
...
ibutton_12 <- read_csv(my_files_12, id = "plot", skip = 19) %>% 
  mutate(plot = str_remove(plot, 
                           "C:/Users/tenni/Desktop/Piru2020/piru_landscape/data/raw_data/Ibutton_Data/ibutton_2/temperature/skip_19/"),
         plot = str_remove(plot, ".csv"),
         plot = str_remove(plot, "Plot_"),
         plot = str_remove(plot, "T"),
         plot = as.numeric(plot),
...
humidity_1 <- read_csv(h_files_1, id = "plot", skip = 18) %>% 
  mutate(plot = str_remove(plot, "C:/Users/tenni/Desktop/Piru2020/piru_landscape/data/raw_data/Ibutton_Data/2_16_21/humidity/"),
...
humidity_2 <- read_csv(h_files_2, id = "plot") %>% 
  mutate(plot = str_remove(plot, "C:/Users/tenni/Desktop/Piru2020/piru_landscape/data/raw_data/Ibutton_Data/4_10_20/For_R/Humidity/"),
         plot = str_remove(plot, "Plot_"),
         plot = str_remove(plot, ".csv"),
...
humidity_3 <- read_csv(h_files_3, id = "plot", skip = 18) %>% 
  mutate(plot = str_remove(plot, "C:/Users/tenni/Desktop/Piru2020/piru_landscape/data/raw_data/Ibutton_Data/4_23_20/Raw_Data/Humidity/"),
         plot = str_remove(plot, "Plot_"),
         plot = str_remove(plot, ".csv"),
         plot = as.numeric(plot),
         humidity = as.numeric(Value),
...
humidity_4 <- read_csv(h_files_4, id = "plot", skip = 18) %>% 
  mutate(plot = str_remove(plot, "C:/Users/tenni/Desktop/Piru2020/piru_landscape/data/raw_data/Ibutton_Data/10_22_20/humidity/"),
         plot = str_remove(plot, "H.csv"),
         plot = as.numeric(plot),
         humidity = as.numeric(Value),
         `Date/Time` = str_replace(`Date/Time`, " A", "_A"),
...
humidity_5 <- read_csv(h_files_5, id = "plot", skip = 18) %>% 
  mutate(plot = str_remove(plot, "C:/Users/tenni/Desktop/Piru2020/piru_landscape/data/raw_data/Ibutton_Data/ibutton/humidity/"),
         plot = str_remove(plot, "h.csv"),
         plot = as.numeric(plot),
         Value = str_remove(Value, "%RH,"),
         date = mdy(`Date/Time`),
...
humidity_6 <- read_csv(h_files_6, id = "plot", skip = 18) %>% 
  mutate(plot = str_remove(plot, "C:/Users/tenni/Desktop/Piru2020/piru_landscape/data/raw_data/Ibutton_Data/ibutton_2/humidity/"),
         plot = str_remove(plot, "H.csv"),
         plot = str_remove(plot, ".csv"),
         plot = as.numeric(plot),
         humidity = as.numeric(Value),
