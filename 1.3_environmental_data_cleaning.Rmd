---
title: "Environmental data cleaning"
author: "Shane Dewees"
date: "2/14/2022"
...
write.csv(moisture_loggers, here("data", "clean_data", "soil_moisture_measured.csv"), row.names = FALSE)
```
...
write.csv(ibutton, here("data", "clean_data", "temperature_measured.csv"), row.names = FALSE)
```
...
write.csv(humidity, here("data", "clean_data", "humidity_measured.csv"), row.names = FALSE)
```
