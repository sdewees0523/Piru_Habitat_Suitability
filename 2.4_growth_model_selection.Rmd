---
title: "Dredge for seasonal growth models"
author: "Shane Dewees"
...
write.csv(as.data.frame(spring_all_dredge), here("data", "models", "dredge_tables", "growth_spring_all_dredge.csv"), row.names = FALSE)
write.csv(spring_all_dredge_filter, here("data", "models", "dredge_tables", "growth_spring_all_dredge_filtered.csv"), row.names = FALSE)
...
write.csv(as.data.frame(early_spring_dredge), here("data", "models", "dredge_tables", "growth_early_spring_dredge.csv"), row.names = FALSE)
write.csv(early_spring_dredge_filter, here("data", "models", "dredge_tables", "growth_early_spring_dredge_filtered.csv"), row.names = FALSE)
...
write.csv(as.data.frame(late_spring_dredge), here("data", "models", "dredge_tables", "growth_late_spring_dredge.csv"), row.names = FALSE)

write.csv(late_spring_dredge_filter, here("data", "models", "dredge_tables", "growth_late_spring_dredge_filtered.csv"), row.names = FALSE)
```
...
write.csv(as.data.frame(summer_all_dredge), here("data", "models", "dredge_tables", "growth_summer_all_dredge.csv"), row.names = FALSE)
write.csv(summer_all_dredge_filter, here("data", "models", "dredge_tables", "growth_summer_all_dredge_filtered.csv"), row.names = FALSE)
...
late_summer_dredge_filter <- late_summer_dredge %>% 
  ...
  distinct() %>% 
  as.data.frame()
write.csv(as.data.frame(late_summer_dredge), here("data", "models", "dredge_tables", "growth_late_summer_dredge.csv"), row.names = FALSE)
write.csv(late_summer_dredge_filter, here("data", "models", "dredge_tables", "growth_late_summer_dredge_filtered.csv"), row.names = FALSE)
...
write.csv(as.data.frame(fall_dredge), here("data", "models", "dredge_tables", "growth_fall_dredge.csv"), row.names = FALSE)
write.csv(fall_dredge_filter, here("data", "models", "dredge_tables", "growth_fall_dredge_filtered.csv"), row.names = FALSE)
```
