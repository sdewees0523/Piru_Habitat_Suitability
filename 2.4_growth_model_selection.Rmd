...
```{r}
summer_growth_model <- glm(growth ~ les_2 + temperature + wood_density + wue + les_2*temperature, data = growth_summer_data)
plot(summer_growth_model)
summary(summer_growth_model)

save(summer_growth_model, file = here("data", "models", "summer_growth_model.rda"))
```
